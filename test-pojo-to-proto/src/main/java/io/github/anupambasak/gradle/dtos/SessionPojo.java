...
import io.github.anupambasak.gradle.testenums.AppConstants.TxnType;
import lombok.Data;

import java.util.List;

/**
 * Uses enums nested in {@link AppConstants} both by simple (imported) name and by qualified name,
...
public class SessionPojo {
    ...
    private AppConstants.RecordStatus recordStatus;
